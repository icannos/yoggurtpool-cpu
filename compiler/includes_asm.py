...
global exclusions
exclusions = ["ligne.effetrepl", "ligne.ligne", "ligne.vide", "ligne.lignepleine", "ligne.majligne","time.time", "graph.clear_screen", "graph.fill", "graph.plot", "graph.draw", "graph.putchar", "graph.estnoir" , "keyboard.waitkey"]
